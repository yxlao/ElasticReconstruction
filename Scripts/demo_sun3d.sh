...
pcl_kinfu_largeScale_release.exe -r -ic -sd 10 -oni ../sandbox/input.oni -vs 4 --fragment 25 --rgbd_odometry --record_log ../sandbox/100-0.log --camera SUN3D.param
mkdir ../sandbox/pcds/
...
Integrate.exe --pose_traj ../sandbox/pose_slac.log --seg_traj ../sandbox/100-0.log --ctr ../sandbox/output.ctr --num ${numpcds} --resolution 12 --camera SUN3D.param -oni ../sandbox/input.oni --length 4.0 --interval 50
