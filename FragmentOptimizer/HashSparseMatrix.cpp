...
void HashSparseMatrix::AddJb(int idx[], double val[], int n, double b,
                             Eigen::VectorXd &Jb) {
    for (int i = 0; i < n; i++) {
...
void HashSparseMatrix::AddHessian(int idx[], double val[], int n,
                                  TripletVector &data) {
    for (int i = 0; i < n; i++) {
        for (int j = 0; j < n; j++) {
...
void HashSparseMatrix::AddHessian(int idx1[], double val1[], int n1, int idx2[],
